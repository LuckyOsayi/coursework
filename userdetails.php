<?php
    ...
    if(isset($_POST["submit"])){
        try{
            ...
            if($statement === false){
                header("location: userdetails.php?updated=false");
                exit;
            }
    ...
    try{
        ...
        if(!isset($_GET["userid"]) || empty($_GET["userid"])){
            header("location: users.php?error=noUser");
        }else{
            $userid = $_GET["userid"];
        }
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form action="userdetails.php" method="POST">
                                ...
                                <?php
                                    $act = "locale.php?userid=".$user["id"]."&action=activate";
                                    $de_act = "locale.php?userid=".$user["id"]."&action=deactivate";
